...
`endif // SCR1_DBG_EN
    ...
    input   logic [1:0]                             imem_hresp,
    // output  logic [SCR1_AHB_WIDTH-1:0]              imem_hwdata, // Заглушка для Qsys
    output  logic [31:0]                            imem_hwdata, // Заглушка для Qsys
